...
.zhzw-loginwrapper-userform {
  height: 100%;
  padding: 80px;
}
.zhzw-loginwrapper-userform-content {
  height: 100%;
  padding: 80px 80px 0;
  border: 1px solid #ccc;
  border-radius: 8px;
}
.zhzw-loginwrapper-icons {
  height: 100%;
  text-align: center;
  padding-top: 20px;
}
...
.zhzw-loginwrapper-userform-buttonbox {
  text-align: center;
}
::v-deep .xuibigbutton {
  width: 65%;
}
.zhzw-loginwrapper-userform-title {
  font-size: 32px;
  font-weight: normal;
  margin-bottom: 30px;
  text-align: center;
...
<template>
  <div class="zhzw-login">
    <div class="zhzw-loginwrapper">
      <div class="zhzw-loginwrapper-userform">
        <div class="zhzw-loginwrapper-userform-content">
          <h4 class="zhzw-loginwrapper-userform-title">基于nuxt搭建的Vue基座</h4>
